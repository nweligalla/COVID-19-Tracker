...
class _FAQScreenState extends State<FAQScreen> {
  List<FAQ> faqData = [
    ...
    FAQ(
        question:
            "what should i do if i have come in close contact ith someone who has covid-19",
        answer:
    ...
    FAQ(
        question:
            "what id different between self-isolation,self quarentine and distancing",
        answer:
    ...
    FAQ(
        question: "can children adolescents catch covid-19",
        answer:
    ...
    FAQ(
        question: "is there a vaccine,drug or treatment for",
        answer:
    ...
    FAQ(
        question:
            "how long does it take after exposure to covid-19 to develop sysptoms",
        answer:
    ...
    FAQ(
        question: "what is a connection between covid-19 and animals",
        answer:
